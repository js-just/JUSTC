...
JUSTC depends on:
- [CPR](https://github.com/libcpr/cpr) [^2]
- [JSON](https://github.com/nlohmann/json) by [Niels Lohmann](https://github.com/nlohmann) [^3]
- [Lua](https://www.lua.org/) by [PUC-Rio](https://www.puc-rio.br/) [^4]
- [Luau](https://github.com/luau-lang/luau) by [Roblox](https://github.com/Roblox) [^5]
- [QuickJS](https://github.com/bellard/quickjs) by [bellard](https://github.com/bellard) [^6]
- [QuickJS CMake](https://github.com/robloach/quickjs-cmake) by [Rob Loach](https://github.com/RobLoach) [^7]

> [!NOTE]
> JUSTC WebAssembly module does not depend on `CPR`, `JSON`, `QuickJS` and `QuickJS CMake`. Instead, it uses JavaScript.
...
[^2]: CPR is licensed under the MIT License: https://github.com/libcpr/cpr/blob/master/LICENSE
[^3]: JSON by Niels Lohmann is licensed under the MIT License: https://github.com/nlohmann/json/blob/develop/LICENSE.MIT
[^4]: Lua is licensed under the MIT License: https://www.lua.org/license.html
[^5]: Luau is licensed under the MIT License: https://github.com/luau-lang/luau/blob/master/LICENSE.txt
[^6]: QuickJS is licensed under the MIT License: https://github.com/bellard/quickjs/blob/master/LICENSE
[^7]: QuickJS CMake is licensed under the MIT License: https://github.com/RobLoach/quickjs-cmake/blob/master/LICENSE
