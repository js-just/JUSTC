...
const monacoJUSTClang = {
        ...
        builtinFunctions: /\b(echo|log|logfile|valueof|String(::(Reverse|Trim|Repeat|Slice|(Start|End)sWith)|)|Number|Link|Binary(::((To|From)(Text|DataURL))|)|Octal|Hexadecimal|typeid|typeof|JSON|file|size|env|config|parseInt|JUSTC|PARSEJUSTC|PARSEJSON|TIME|PI|BACKSLASH|VERSION|HTTP::(GET|POST|PUT|PATCH|DELETE|HEAD|OPTIONS)|Math::(Abs|A(cos|sin|tan(2|))|Ceil|Cos|Clamp|Cube|Double|Exp|Factorial|Floor|Hypot|IsPrime|Lerp|Log(10|)|Max|Min|Pow|Random|Round|Sign|Sin|Sqrt|Square|Tan|To(Degrees|Radians)|ParseNum)|Data)\b/i,
